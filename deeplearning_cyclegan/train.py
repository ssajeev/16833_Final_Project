...
parser.add_argument('--data_path',                 type=str,   help='path to the data', default='H:/16833/daVinci/test/')
parser.add_argument('--filenames_file',            type=str,   help='path to the filenames text file', default='endoscopy.txt')
